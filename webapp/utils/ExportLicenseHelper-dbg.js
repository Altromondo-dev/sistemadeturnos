sap.ui.define([
	...
	return {
		...
		createNormalPDFBody: function (content, licencia, oTextos, Entregas,
		...
		createPdfLicense: function (
			...
			if (!bExportType) {
				...
				content = this.createNormalPDFBody(content, licencia, oTextos, Entregas,
					Devoluciones, Suspensiones, Reanudaciones,
					Observaciones, Coordinaciones, Tramitaciones,
					Transferencias);
			}
		...
		createEntregasDevoluciones: function (licencia, Entregas, content, Devoluciones) {
			...
			content.push({
				table: {
					...
					body: [
						[{
							text: "ENTREGAS y DEVOLUCIÓNES/CANCELACIÓNES DE EQUIPO",
							alignment: 'center',
							fillColor: tableFillColor
						}]
					]
